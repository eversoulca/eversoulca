...
const VirtualLove = () => {
  ...
  return (
    <div className="uploadsoul-page-container">
      <Helmet>
      ...
      {hasAvatar && (
        ...
        .soul-title {
          position: absolute; top: 80px; left: 40px; z-index: 5;
      ...
      `}</style>
          ...
          <div className="interaction-deck">
            <div className="deck-header">
              ...
              {systemLog && <div className="system-log" title={systemLog}>{systemLog}</div>}
            </div>
